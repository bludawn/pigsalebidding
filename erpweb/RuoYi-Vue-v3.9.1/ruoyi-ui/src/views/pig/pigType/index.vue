  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" label-width="120px">
        <el-form-item label="生猪名称" prop="pigName">
          <el-input v-model="form.pigName" placeholder="请输入生猪名称" />
        </el-form-item>
        <el-form-item label="生猪编码" prop="pigCode">
          <el-input v-model="form.pigCode" placeholder="请输入生猪编码" />
        </el-form-item>
        <el-form-item label="生猪介绍" prop="pigIntro">
          <el-input v-model="form.pigIntro" type="textarea" placeholder="请输入生猪介绍" />
        </el-form-item>
        <el-form-item label="生猪标签" prop="pigTagIds">
          <el-input v-model="form.pigTagIds" placeholder="请输入标签id，多个用逗号隔开" />
        </el-form-item>
        <el-form-item label="体重区间" prop="weightRange">
          <el-input v-model="form.weightRange" placeholder="请输入体重区间" />
        </el-form-item>
        <el-form-item label="生猪图片" prop="pigImages">
          <el-input v-model="form.pigImages" placeholder="请输入图片URL，多个用逗号隔开" />
        </el-form-item>
        <el-form-item label="生猪视频" prop="pigVideos">
          <el-input v-model="form.pigVideos" placeholder="请输入视频URL，多个用逗号隔开" />
        </el-form-item>
        <el-form-item label="食料品质" prop="feedQuality">
          <el-input v-model="form.feedQuality" placeholder="请输入食料品质" />
        </el-form-item>
        <el-form-item label="防疫状态" prop="epidemicStatus">
          <el-input v-model="form.epidemicStatus" placeholder="请输入防疫状态" />
        </el-form-item>
        <el-form-item label="无疫地区" prop="diseaseFreeRegion">
          <el-input v-model="form.diseaseFreeRegion" placeholder="请输入无疫地区" />
        </el-form-item>
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != undefined) {
            updatePigType(this.form).then(() => {
              this.$modal.msgSuccess("修改成功")
              this.open = false
              this.getList()
            })
          } else {
            addPigType(this.form).then(() => {
