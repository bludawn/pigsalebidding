  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="90px">
      <el-form-item label="用户id" prop="id">
        <el-input v-model="queryParams.id" placeholder="请输入用户id" clearable style="width: 240px" @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="userExtList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户id" align="center" prop="id" v-if="columns.id.visible" />
      ...
      <el-table-column label="所属企业id" align="center" prop="enterpriseId" v-if="columns.enterpriseId.visible" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <el-form-item label="实名认证" prop="isRealName">
          <el-select v-model="form.isRealName" placeholder="请选择是否实名认证">
            <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      columns: {
        id: { label: '用户id', visible: true },
        isRealName: { label: '实名认证', visible: true },
        enterpriseId: { label: '所属企业id', visible: true },
