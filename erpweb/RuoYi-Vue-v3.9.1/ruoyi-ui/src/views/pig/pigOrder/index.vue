<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="pigOrderList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <el-form-item label="送货信息id数组" prop="deliveryInfoIds">
          <el-input v-model="form.deliveryInfoIds" placeholder="请输入送货信息id数组" />
        </el-form-item>
...
<script>
import { listPigOrder, getPigOrder, delPigOrder, addPigOrder, updatePigOrder } from "@/api/pig/pigOrder"

export default {
  name: "PigOrder",
  dicts: ['pig_order_status', 'pig_order_source'],
  data() {
    return {
      loading: true,
      ids: [],
